        ...
        <header class="gdlr-header-wrapper">
            <div class="dlr-header-inner">
                <div class="gdlr-header-container container">
                    <div class="gdlr-logo">
                        <a href=""> <img src="{!! asset('rede_4_jue_civ/red/images/logo_red_1.png') !!}" alt=""> </a>
									...
									<div class="gdlr-session-item-tab-content gdlr-tab-3">
                                       ...
                                       <div class="gdlr-session-item-content-wrapper">
                                        ...
                                        <div class="gdlr-session-item-content-wrapper">
                                            ...
                                            <div class="gdlr-session-item-content-info">
                                                <div class="gdlr-session-info">
                                                    <div class="session-info session-time"><i class="fa fa-clock-o"></i>18:30 A 19:45  hrs.</div>
                                                    <div class="session-info session-speaker">
                                                        <div class="session-speaker-inner">
                                                            <div class="session-speaker-list">
																<div class="gdlr-session-item-excerpt">Conferencia magistral</div>
                                        ...
                                        <div class=gdlr-session-item-content-wrapper>
                                                ...
                                                <div class=session-break-content>
                                                    ...
                                                    <h3 class="gdlr-session-break-title">Cierre de los trabajos de la Red</h3>
                                                </div>
                                                <div class=clear></div>
                                         </div>
								  </div>
