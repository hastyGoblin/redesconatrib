        ...
        <header class="gdlr-header-wrapper">
            <div class="dlr-header-inner">
                <div class="gdlr-header-container container">
                    <div class="gdlr-logo">
                        <a href=""> <img src="{!! asset('rede_7_sijpa/red/images/logo_cooperacion.png') !!}" alt=""> </a>
            ...
            <div class="gdlr-content">
                <div class="with-sidebar-wrapper gdlr-type-no-sidebar">
                                    ...
                                    <div class="gdlr-session-item-tab-content gdlr-tab-1 gdlr-active">
										...
										<div class=gdlr-session-item-content-wrapper>
                                                ...
                                                <div class=session-break-content>
                                                    ...
                                                    <h3 class="gdlr-session-break-title">Mensaje de bienvenida de la Magistrada Sara Patricia Orea Ochoa </h3></div>
                                                <div class=clear></div>
                                        </div>
										<div class="gdlr-session-item-content-wrapper">
                                           <div class="gdlr-session-item-divider"></div>
                                                      ...
                                                      <div class="session-info session-speaker">
                                                        <div class="session-speaker-inner">
                                                            <div class="session-speaker-list">
                                                                ...
                                                                <div class="session-speaker-list-item"><i class="fa fa-user"></i><a>Mtra. Sarahi García</a></div>
																<div class="gdlr-session-item-excerpt">Directora Nacional de Proyectos de Justicia Juvenil Internacional México A.C.</div>
                                                            </div>
															<div class="session-speaker-list">
                                                                <div class="session-speaker-list-item"><i class="fa fa-user"></i><a>Dr. Javier Carrasco</a></div>
																<div class="gdlr-session-item-excerpt">Director Ejecutivo del Instituto de Justicia Procesal Penal A.C.</div>
                                                            </div>
															<div class="session-speaker-list">
																<div class="session-speaker-list-item"><a>Moderadora:</a></div>
                                                                <div class="session-speaker-list-item"><i class="fa fa-user"></i><a>Mtra. Nadia Hernández Jaimes</a></div>
																<div class="gdlr-session-item-excerpt">Jueza de Transición en Materia de Justicia para Adolescentes del Tribunal Superior de Justicia de la Ciudad de México</div>
                                                            </div>
                                                        </div>
                                                      </div>
                                                    <div class="clear"></div>
                                            ...
                                            <div class="gdlr-session-item-content">
                                               <h3 class="gdlr-session-item-title">Juicios en línea, ¿Violación al debido proceso o no?</h3>
												<div class="gdlr-session-item-excerpt">Debate </div>
											    <div class="gdlr-session-thumbnail-wrapper">
                                                     <article class="type-post">
															<div class="entry-cover">
																<iframe width="560" height="315" src="https://www.youtube.com/embed/o0hiqZ1oR3A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
															</div>
													            <div class="entry-block"></div>
													 </article>
                                                 </div>
										...
										<div class="gdlr-session-item-content-wrapper">
                                           <div class="gdlr-session-item-divider"></div>
                                                    ...
                                                    <div class="session-info session-time"><i class="fa fa-clock-o"></i>11:30  hrs.</div>
                                                      <div class="session-info session-speaker">
                                                        <div class="session-speaker-inner">
                                                            <div class="session-speaker-list">
																<div class="session-speaker-list-item"><a>Ponentes:</a></div>
                                                                <div class="session-speaker-list-item"><i class="fa fa-user"></i><a>Dra. Alicia Azzolini</a></div>
																<div class="gdlr-session-item-excerpt">Investigadora Titular del Departamento de Derecho, Universidad Autónoma Metropolitana</div>
                                                            </div>
															<div class="session-speaker-list">
                                                                <div class="session-speaker-list-item"><i class="fa fa-user"></i><a>Mtro. Francisco Santamaría</a></div>
																<div class="gdlr-session-item-excerpt">Primera Sala de Justicia para Adolescentes, Poder Judicial de la Ciudad de México</div>
                                                            </div>
															<div class="session-speaker-list">
																<div class="session-speaker-list-item"><a>Moderadora:</a></div>
                                                                <div class="session-speaker-list-item"><i class="fa fa-user"></i><a>Mtra. María Guadalupe Valenzuela Velarde</a></div>
																<div class="gdlr-session-item-excerpt">Jueza del Sistema Procesal Penal Acusatorio en Materia de Justicia para Adolescentes de la Ciudad de México</div>
                                                            </div>
                                                        </div>
                                                      </div>
                                                    <div class="clear"></div>
                                            ...
                                            <div class="gdlr-session-item-content">
                                               <h3 class="gdlr-session-item-title">Procesamiento de niños inimputables</h3>
												<div class="gdlr-session-item-excerpt">Debate </div>
											    <div class="gdlr-session-thumbnail-wrapper">
                                                     <article class="type-post">
															<div class="entry-cover">
										...
										<div class=gdlr-session-item-content-wrapper>
                                                ...
                                                <div class=session-break-content>
                                                    ...
                                                    <h3 class="gdlr-session-break-title">Mensaje de despedida de la Magistrada Sara Patricia Orea Ochoa </h3></div>
                                                <div class=clear></div>
                                        </div>
								 </div>
                                    <!-- termina dia -->
                    ...
                    <section id="ponentescdmx">
                        ...
                        <div class="gdlr-item-title-wrapper gdlr-item pos-center ">
                                    <div class=gdlr-item-title-head>
                                        <h3 class="gdlr-item-title gdlr-skin-title gdlr-skin-border gdlr-title-medium">PONENTES</h3>
                                        <br>
                                    </div>
                                </div>
                                        ...
                                        <div class=flexslider data-type=carousel data-nav-container=speaker-item-wrapper data-columns=4>
                                            <ul class=slides>
                                                <li class="gdlr-item gdlr-speaker-item">
                                                    <div class=gdlr-speaker-thumbnail><img src="rede_7_sijpa/red/images/img_ponentes/Sarahi_Garcia_.png" alt width=400 height=400></div>
                                                    <div class=gdlr-speaker-item-content>
                                                        <h3 class="gdlr-speaker-item-title gdlr-skin-title">Mtra. Sarahi García</h3>
														<div class="gdlr-session-item-excerpt">Directora Nacional de Proyectos de Justicia Juvenil Internacional México A.C.</div>
                                                ...
                                                <li class="gdlr-item gdlr-speaker-item">
                                                    <div class=gdlr-speaker-thumbnail><img src="rede_7_sijpa/red/images/img_ponentes/Javier_Carrasco_.png" alt width=400 height=400></div>
                                                    <div class=gdlr-speaker-item-content>
                                                        <h3 class="gdlr-speaker-item-title gdlr-skin-title">Dr. Javier Carrasco</h3>
														<div class="gdlr-session-item-excerpt">Director Ejecutivo del Instituto de Justicia Procesal Penal A.C.</div>
                                                ...
                                                <li class="gdlr-item gdlr-speaker-item">
                                                    <div class=gdlr-speaker-thumbnail><img src="rede_7_sijpa/red/images/img_ponentes/Nadia_Hernandez_.png" alt width=400 height=400></div>
                                                    <div class=gdlr-speaker-item-content>
                                                        <h3 class="gdlr-speaker-item-title gdlr-skin-title">Mtra. Nadia Hernández Jaimes</h3>
														<div class="gdlr-session-item-excerpt">Jueza de Transición en Materia de Justicia para Adolescentes del Tribunal Superior de Justicia de la Ciudad de México.</div>
                                                ...
                                                <li class="gdlr-item gdlr-speaker-item">
                                                    <div class=gdlr-speaker-thumbnail><img src="rede_7_sijpa/red/images/img_ponentes/Alicia_Azzolini_.png" alt width=400 height=400></div>
                                                    <div class=gdlr-speaker-item-content>
                                                        <h3 class="gdlr-speaker-item-title gdlr-skin-title">Dra. Alicia Azzolini</h3>
														<div class="gdlr-session-item-excerpt">Investigadora Titular del Departamento de Derecho, Universidad Autónoma Metropolitana </div>
                                    ...
                                    <div class="gdlr-item gdlr-speaker-carousel-wrapper">
                                        <div class=flexslider data-type=carousel data-nav-container=speaker-item-wrapper data-columns=4>
                                            <ul class=slides>
                                             ...
                                             <li class="gdlr-item gdlr-speaker-item">
                                                    <div class=gdlr-speaker-thumbnail><img src="rede_7_sijpa/red/images/img_ponentes/Francisco_Santamaria_.png" alt width=400 height=400></div>
                                                    <div class=gdlr-speaker-item-content>
                                                        <h3 class="gdlr-speaker-item-title gdlr-skin-title">Mtro. Francisco Santamaría</h3>
														<div class="gdlr-session-item-excerpt">Primera Sala de Justicia para Adolescentes, Poder Judicial de la Ciudad de México</div>
												...
												<li class="gdlr-item gdlr-speaker-item">
                                                    <div class=gdlr-speaker-thumbnail><img src="rede_7_sijpa/red/images/img_ponentes/Maria_G_Valenzuela_.png" alt width=400 height=400></div>
                                                    <div class=gdlr-speaker-item-content>
                                                        <h3 class="gdlr-speaker-item-title gdlr-skin-title">Mtra. María Guadalupe Valenzuela Velarde</h3>
														<div class="gdlr-session-item-excerpt">Jueza del Sistema Procesal Penal Acusatorio en Materia de Justicia para Adolescentes de la Ciudad de México</div>
